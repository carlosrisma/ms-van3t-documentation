...
namespace ns3 {
  ...
  private:
        ...
        const double m_stddev_distance = 1.0; ///! Standard deviation of the perception's distance noise
        const double m_stddev_angle = 0.57; ///! Standard deviation of the perception's angle noise
        const double m_stddev_speed = 0.45; ///! Standard deviation of the perception's speed noise
